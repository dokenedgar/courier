            ...
            <div class="col-lg-12">
                ...
                <h3 class="text-center">Enter Your Tracking Code</h3>
						...
						<h4 class="text-center">
							<form name="myForm" action="process.html" method="post" onsubmit="return validateForm()">
								<input type="text" name="trackcode" placeholder="Enter Tracking Code" required /><br><br>
				...
				<script type="text/javascript">
					function validateForm() {
					    var x = document.forms["myForm"]["trackcode"].value;
					    if (x == null || x == "") {
