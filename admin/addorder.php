...
$_SESSION['adminpage']   = 'addorder';
?>

<!DOCTYPE html>
<html>
<head>
<title>Add Order - Courier Store</title>
...
<section class="about-w3ls">
	<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
				<br>
                <h3 class="text-center">Place An Order</h3>
...
<!--
        ...
        <div class="form-group">
          <label for="shipmentDate">Shipment Date: </label><em>&nbsp;Format - mm/dd/yyyy or 15 March 2010</em> 
...
<br>
        ...
        <div class="form-group">
          ...
          <button id="orderbutton" class="btn btn-primary">
          Create Order</button>
