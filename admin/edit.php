...
<html>
<head>
<title>Edit - Kenday Logistics</title>
...
<section class="about-w3ls">
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-6">
			<form method="POST" action="edit_details.php" name="editForm" onsubmit="return validateEditForm()">
		...
		<center>		<button type="submit" name="submit" id="submit" class="btn btn-primary">Get Records</button></center>
        		...
        		<script type="text/javascript">
					function validateEditForm() {
					    var x = document.forms["editForm"]["trackid"].value;
					    if (x == null || x == "") {
